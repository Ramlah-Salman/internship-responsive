...
if (websiteUrl.includes("/category-view/category.html?Electronic")) {
  let itemCol = document.querySelector(".item-col-2");

  // let selectStar = document.querySelectorAll(".fa-star");

  // console.log(selectStar.length);
  // for (let i = 0; i < selectStar.length; i++) {
  //   console.log(selectStar[i], "hello");
  // }

  async function techFetch() {
    const url = "./category-json/tech.json";
