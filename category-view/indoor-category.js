...
if (websiteUrl.includes("/category-view/category.html?Indoor")) {
  let itemCol = document.querySelector(".item-col-2");

  async function indoorFetch() {
    const url = "./category-json/indoor.json";
    try {
  ...
  async function getIndoorData() {
    let data = await indoorFetch();
